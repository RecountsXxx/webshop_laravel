...
class VendorController extends Controller
{
    ...
    {
        try {
            $vendor =  $this->vendorService->show_per_id($request->id);
    ...
    public function get_products_on_vendor(VendorRequest $request)
    {
        try {
            $products =  $this->vendorService->get_products_on_vendor($request->id);
